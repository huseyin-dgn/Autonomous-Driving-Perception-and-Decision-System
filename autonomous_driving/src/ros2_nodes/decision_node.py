...
class DecisionNode(Node):
    ...
    def get_best_sign(self, detections):
        ...
        for det in detections:
            ...
            sign_type = str(det.get("sign_type", "unknown"))
    ...
    def stabilize_decision(self, output):
        ...
        prev_time = self.last_output_time
        age = now - prev_time

        # STOP'tan çıkarken kısa tutma: titreşim/tek frame kaçırma olmasın.
        ...
        # SLOW'dan GO'ya çıkarken de küçük histerezis.
